...
@section('content')
    <main class="s-layout__content px-3">
        <h2 class="mb-5"><u>Project Technical</u></h2>
        <div class="row p-4 border">
            ...
            <div class="col-lg-6">
                ...
                <div class="radio-container px-3">
                    <input type="radio" id="monoPercHalfCut" name="property-type2" value="Residential">
                    <label for="monoPercHalfCut" class=" fw-normal radio-label">Mono-PERC Half Cut</label>

                    <input type="radio" id="mono" name="property-type2" value="Commercial">
                    <label for="mono" class=" fw-normal radio-label">Mono Perc Bifacial</label>

                    <input type="radio" id="topCon" name="property-type2" value="Industrial">
            ...
            <div class="col-lg-6">
                ...
                <div class="radio-container px-3">
                    <input type="radio" id="adani" name="property-type3" value="Residential">
                    <label for="adani" class=" fw-normal radio-label">Adani</label>

                    <input type="radio" id="gautam" name="property-type3" value="Commercial">
                    <label for="gautam" class=" fw-normal radio-label">Gautam</label>

                    <input type="radio" id="Vikram" name="property-type3" value="Commercial">
                    <label for="Vikram" class=" fw-normal radio-label">Vikram</label>

                    <input type="radio" id="loom" name="property-type3" value="Industrial">
                    <label for="loom" class=" fw-normal radio-label"> Loom</label>

                    <input type="radio" id="Saatvik" name="property-type3" value="Industrial">
            ...
            <div class="col-lg-6">
                ...
                <div class="radio-container px-3">
                    <input type="radio" id="Polycab" name="property-type1" value="Residential">
                    <label for="Polycab" class=" fw-normal radio-label">Polycab</label>

                    <input type="radio" id="KEI" name="property-type1" value="Commercial">
                    <label for="KEI" class=" fw-normal radio-label"> KEI</label>

                    <input type="radio" id="Finolex" name="property-type1" value="Commercial">
                    <label for="Finolex" class=" fw-normal radio-label">Finolex</label>

                    <input type="radio" id="Others" name="property-type1" value="Industrial">
